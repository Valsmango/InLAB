    ...
    # for t in range(int(max_train_steps)):
        ...
        if done:
            ...
            if (episode_num + 1) % 100 == 0:
                ...
                np.save('./eval_reward_train/DDPG/train_collision_DDPG_env_{}_seed_{}.npy'.format(env_name, seed),
                        np.array(train_episode_collision_rate))
                np.save('./eval_reward_train/DDPG/train_ma_collision_DDPG_env_{}_seed_{}.npy'.format(env_name, seed),
