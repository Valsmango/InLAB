...
if __name__ == '__main__':
    ...
    if not os.path.exists("eval_reward_train/TD3LSTMATT"):
        os.makedirs("./eval_reward_train/TD3LSTMATT")
    ...
    # for t in range(int(max_train_steps)):
        ...
        if done:
            ...
            if (episode_num + 1) % 100 == 0:
                np.save('./eval_reward_train/TD3LSTMATT/train_reward_TD3LSTMATT_env_{}_seed_{}.npy'.format(env_name, seed),
                        np.array(train_episode_rewards))
                np.save('./eval_reward_train/TD3LSTMATT/train_ma_reward_TD3LSTMATT_env_{}_seed_{}.npy'.format(env_name, seed),
                        np.array(train_episode_ma_rewards))
                np.save('./eval_reward_train/TD3LSTMATT/train_success_TD3LSTMATT_env_{}_seed_{}.npy'.format(env_name, seed),
                        np.array(train_episode_success_rate))
                np.save('./eval_reward_train/TD3LSTMATT/train_ma_success_TD3LSTMATT_env_{}_seed_{}.npy'.format(env_name, seed),
                        np.array(train_episode_ma_success_rate))
                np.save('./eval_reward_train/TD3LSTMATT/train_collision_TD3LSTMATT_env_{}_seed_{}.npy'.format(env_name, seed),
                        np.array(train_episode_collision_rate))
                np.save('./eval_reward_train/TD3LSTMATT/train_ma_collision_TD3LSTMATT_env_{}_seed_{}.npy'.format(env_name, seed),
