...
if __name__ == "__main__":
    ...
    # avg_eval_result_plot(rewards=avg_rewards, eval_frequent=5000)
    ########
    # training_rewards = np.load(f"./eval_reward_train/MATD3_COMMON/train_reward_{file_name}.npy")
    # training_rewards_plot(training_rewards)
    #########
    training_ma_rewards = np.load(f"./eval_reward_train/MATD3_COMMON/train_ma_reward_{file_name}.npy")
    training_ma_rewards_plot(training_ma_rewards)
